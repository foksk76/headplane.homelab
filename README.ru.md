...
> проверенные на промежуточном хосте сборки и Debian 13 VPS. В текущую
> проверку уже входит живой откат из резервной копии, сделанной до включения
> OIDC, включая ожидаемую инвалидизацию более новых ключей API Headscale после
> восстановления `db.sqlite`.
